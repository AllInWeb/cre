...
Логин для жюри: tttt
Логин для ретейлера: test1
Пароли: 1111

В папке sites/default/отсутствует файл settings.php, его нужно создать,
со следующим содержанием(не забудьте прописать свого пользлвателя и пароль к БД)
